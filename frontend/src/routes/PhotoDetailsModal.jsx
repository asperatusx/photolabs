...
const PhotoDetailsModal = (props) => {
  ...
  //Convert similar photos object into array to be displayed
  const similarPhotosArray = Object.values(similar_photos);

  //Pass a boolean if current id is included in fav photos
